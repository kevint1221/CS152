...
//statement blockSyntax error at line
...
Declaration:    	ident COMMA Declaration {printf("declaration -> ident COMMA declaration\n");};
        ...
        |			ident INTEGER {printf("Syntax error at line %d", current_Line); printf(": invalid Declaration\n"); exit(1); };  //handling error 
        
//array block
Array_Block: 		ARRAY L_SQUARE_BRACKET number R_SQUARE_BRACKET OF  {printf("Array_Block -> ARRAY L_PAREN number R_PAREN OF\n");}
...
//var block
Var_Block:      	Var COMMA Var_Block 		{printf("Var_Block -> Var SEMICOLON\n");}
...
// relation casesSyntax error at line
...
Var:           		ident                   {printf( "Var -> ident\n");}
        |      		ident L_SQUARE_BRACKET Expression R_SQUARE_BRACKET     {printf( "Var -> ident L_PAREN expression R_PAREN\n");};
...
void Invalid_Declaration(){
	printf("Syntax error at LINE %d ", current_Line); 
